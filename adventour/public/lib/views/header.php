<header>
  <nav class="container relative mx-auto flex items-center p-2 sm:px-0">
    <a href="/" class="flex w-10 items-center justify-center gap-4 sm:w-auto">
      ...
      <span class="hidden font-cursive text-2xl leading-none text-green-900 sm:block">
        Adventour
      </span>
    </a>
    ...
    <div class="ml-auto flex items-center sm:ml-0 lg:ml-3">
      <div class="hidden items-center justify-around gap-2 lg:flex">
        <a href="/login.php" class="w-[5.5rem] rounded-xl border-2 border-green-900 bg-white p-2 text-center font-medium leading-none text-green-900">Log in</a>
        <a href="/signin.php" class="w-[5.5rem] rounded-xl border-2 border-green-900 bg-green-900 p-2 text-center font-medium leading-none text-white">Sign up</a>
      </div>

      <open-button class="w-10 lg:hidden" target="offpage">
        <b-icon-list class="mx-auto text-4xl leading-[1rem] text-green-900 sm:text-[2.5rem] sm:leading-none"></b-icon-list>
      </open-button>
