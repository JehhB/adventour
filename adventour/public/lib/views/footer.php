<footer class="bg-green-900 sm:bg-gray-300 mt-8">
  <div
    class="container mx-auto flex items-center p-2 sm:flex-col sm:items-end sm:gap-4 sm:px-0 sm:py-8"
  >
    <a href="#">
      <span class="sr-only">Go to top of page</span>
      <img
        src="/assets/images/logo-sm.png"
        alt="White dventour logo"
        class="h-8 sm:hidden"
      />
      <img
        src="/assets/images/logo.webp"
        alt="White dventour logo"
        class="hidden h-8 sm:block sm:h-12"
      />
    </a>
    <div class="hidden flex-col items-end gap-2 sm:flex">
      <p>&copy; 2023 Adventour All rights reserved</p>
      <address>Cagayan, Philippines</address>
    </div>
